...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_COMMAND:
	{
		...
		if (wParam == 1001)
		{
			...
			hInTxt = CreateFile(_T("C:\\Users\\Andrey\\OneDrive\\Документы\\прак2\\readme.txt"), GENERIC_WRITE, FILE_SHARE_WRITE, NULL,
		...
		if (wParam == 1002)
		{
			hOutTxt = CreateFile(_T("C:\\Users\\Andrey\\OneDrive\\Документы\\прак2\\readme.txt"), GENERIC_READ, FILE_SHARE_READ, NULL,
				OPEN_EXISTING, FILE_ATTRIBUTE_NORMAL, NULL);
		...
		if (wParam == 1003)
		{
			hInBin = CreateFile(_T("C:\\Users\\Andrey\\OneDrive\\Документы\\прак2\\readme.bin"), GENERIC_WRITE, FILE_SHARE_WRITE, NULL,
				OPEN_EXISTING, FILE_ATTRIBUTE_NORMAL, NULL);
		...
		if (wParam == 1004)
		{
			hOutBin = CreateFile(_T("C:\\Users\\Andrey\\OneDrive\\Документы\\прак2\\readme.bin"), GENERIC_READ, FILE_SHARE_READ, NULL,
				OPEN_EXISTING, FILE_ATTRIBUTE_NORMAL, NULL);
